...
<script>
    ...
    wx.ready(function () {
        ...
        wx.onMenuShareAppMessage({
            title: '我是<%=NickName.Text%>,我为积福报公益献爱心', // 分享标题
            desc: '我们为爱付出,我们因缘相聚;积福报公益,期待您的加入！', // 分享描述
...
<div class="media">
<div class="media-left media-middle"><img class="media-object" id="userface" runat="server" src="" alt="" onerror="javascript:this.src='/Images/userface/noface.png';" /></div>
<div class="media-body media-middle">
<h4 class="media-heading">我是<asp:Label ID="NickName" runat="server" Text=""></asp:Label> 我为<span>积福报公益</span>代言</h4>
</div>
</div>
</div>
