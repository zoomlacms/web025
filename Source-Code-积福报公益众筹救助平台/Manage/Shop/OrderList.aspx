...
<div id="maindiv">
    <ul id="ordernav" class="nav nav-tabs margin_t5">
       <li data-type="all"><a href="OrderList.aspx?OrderType=<%=OrderType%>"><asp:Label runat="server" ID="order_all_l" Text="全部订单"></asp:Label></a></li>
       <li data-type="unpaid"><a href="OrderList.aspx?filter=unpaid&OrderType=<%=OrderType%>"><asp:Label runat="server" ID="order_unpaid_l" Text="待付款"></asp:Label></a></li>
       <li data-type="prepay"><a href="OrderList.aspx?filter=prepay&OrderType=<%=OrderType%>"><asp:Label runat="server" ID="order_prepay_l" Text="预付款"></asp:Label></a></li>
       <li data-type="paid"><a href="OrderList.aspx?filter=paid&OrderType=<%=OrderType%>"><asp:Label runat="server" ID="order_paid_l" Text="已付款"></asp:Label></a></li>
       <li data-type="unexp"><a href="OrderList.aspx?filter=unexp&OrderType=<%=OrderType%>"><asp:Label runat="server" ID="order_unexp_l" Text="待发货"></asp:Label></a></li>
       <li data-type="exped"><a href="OrderList.aspx?filter=exped&OrderType=<%=OrderType%>"><asp:Label runat="server" ID="order_exped_l" Text="已发货"></asp:Label></a></li>
       <li data-type="finished"><a href="OrderList.aspx?filter=finished&OrderType=<%=OrderType%>"><asp:Label runat="server" ID="order_finished_l" Text="交易完成"></asp:Label></a></li>
       <li data-type="unrefund"><a href="OrderList.aspx?filter=unrefund&OrderType=<%=OrderType%>"><asp:Label runat="server" ID="order_unrefund_l" Text="待退款"></asp:Label></a></li>
       <li data-type="refunded"><a href="OrderList.aspx?filter=refunded&OrderType=<%=OrderType%>"><asp:Label runat="server" ID="order_refunded_l" Text="退款完成"></asp:Label></a></li>
       <li data-type="recycle"><a href="OrderList.aspx?filter=recycle&OrderType=<%=OrderType%>"><asp:Label runat="server" ID="order_recycle_l" Text="回收站"></asp:Label></a></li>
    </ul>
