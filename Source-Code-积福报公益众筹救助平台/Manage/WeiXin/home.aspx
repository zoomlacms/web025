...
<asp:Content runat="server" ContentPlaceHolderID="head">
    ...
    <style>
        body { FILTER: progid:DXImageTransform.Microsoft.Gradient(gradientType=0,startColorStr=#99CCFF,endColorStr=#fff); /*IE 6 7 8*/ background: -ms-linear-gradient(top, #99CCFF, #fff) no-repeat; /* IE 10 */ background: -webkit-gradient(linear, 0% 0%, 0% 100%,from(#99CCFF), to(#fff)) no-repeat; /*谷歌*/ }
    </style>
</asp:Content>
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <div id="MainApp" class="wxapp_box">
        ...
        <div class="wxapp">
            <a href="WxAppManage.aspx"><i class="fa fa-newspaper-o center-block" style="background: #FFC926;"></i>素材管理</a>
        </div>
        <div class="wxapp">
            <a href="Msg/MsgTlpList.aspx?appid=<%:Mid %>"><i class="fa fa-rss center-block" style="background: #0085B2;"></i>高级群发</a>
        </div>
        <div class="wxapp">
        ...
        <div class="wxapp">
            <a href="Msg/MsgTlpList.aspx?appid=<%:Mid %>"><i class="fa fa-history center-block" style="background: #ff006e;"></i>刮刮卡</a>
        </div>
        <div class="wxapp">
            <a href="Msg/MsgTlpList.aspx?appid=<%:Mid %>"><i class="fa fa-futbol-o center-block" style="background: #ff006e;"></i>大转盘</a>
        </div>
        <div class="wxapp">
