...
- [Zoomla!逐浪CMS卓越出品](#zoomla逐浪cms卓越出品)
  - [逐浪官方开源精品全站项目025：积福报公益众筹救助平台](#逐浪官方开源精品全站项目025：积福报公益众筹救助平台)
  - [本项目介绍](#本项目介绍)
- [开放性说明](#开放性说明)
  - [使用说明](#使用说明)
- [接口文档](#接口文档)
...
这是一个-慈善众筹公益平台，对接微信公众号，可在线发起大病救助众筹，爱心汇聚众力量帮助需要帮助的人群，移动优先，全面支持响应式，其特征包括：
- 服务端基于Zoomla!逐浪CMS开发
- 前端web呈现基于Boostrap 
- 支持chrome和现代化浏览器，兼容IE11与EDGE浏览器
- 对接微信公众号，直接移动端发起众筹
- 参与众筹项目公益捐赠
- 后台管理真实信息审核、对接微信会员信息、支持在线支付、爱心捐赠、在线申请，最近提案发布等
